...
-- 说明：
--   1) 新增一台环境监测板设备 D006（物理板子 192.168.12.187:8888），
...
INSERT INTO `device` (`id`, `plot_id`, `name`, `type`, `online`, `running`, `last_heartbeat`, `created_at`)
VALUES ('D006', 'P001', '环境监测板-01', '环境监测板', 1, 0, NOW(), NOW())
